...
namespace Invoicing.Customers.Api.CustomerEndpoints.GetList
{
    public class GetList : BaseAsyncEndpoint<GetCustomerListResult>
    {
        private readonly ICustomerRepository _customerRepository;

        public GetList(ICustomerRepository customerRepository)
        {
